...
def main():
    ...
    label1 = tk.Label(text='two players' ,font=("Arial Rounded MT Bold", 12, "bold"), fg ='white', bg='#003E3E')
    label2 = tk.Label(text='play with computer', font=("Arial Rounded MT Bold", 12, "bold") ,fg ='white', bg='#003E3E')
